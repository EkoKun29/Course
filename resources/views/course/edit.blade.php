<div class="modal modal-blur fade" id="modal-edit-{{ $d->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="form-group">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Kelas</label>
                            <select name="kelas" class="form-control" id="kelas" value="{{ $d->kelas }}">
 ...
 <script>
    ...
    // Fungsi untuk menampilkan harga saat memilih course di luar modal
    $(document).ready(function() {
        $('#nama').on('change', function() {
            var selectedCourse = $(this).val();
            var hargaBarang = hargaBarang[selectedCourse];
            $('#harga_course').val(hargaBarang);
        });
    });
</script>